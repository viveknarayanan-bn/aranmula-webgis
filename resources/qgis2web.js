...
map.getView().fit([8530760.675265, 1038481.256703, 8538722.808609, 1044056.877339], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA_WEBGIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (45 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'it includes resource information of Aranmula.';
            }
